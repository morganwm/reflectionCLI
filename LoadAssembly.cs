        ...
        public LoadAssembly(String path) {
            try
            {
                ...
                if (tempicommand.Count == 0) {
                    throw new System.Exception("Unable to find ICommand");
                }

                if (tempicommand.Count > 1) {
                    throw new System.Exception("Multiple ICommands Found");
                }
                ...
                if (extvalinfo.Count == 0) {
                    throw new System.Exception("ICommands did not return the correct exit value");
                }
